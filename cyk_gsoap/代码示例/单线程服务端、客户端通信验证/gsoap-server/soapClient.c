...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.9 2012-07-23 13:22:19 GMT")
...
{	struct HELLO__hello soap_tmp_HELLO__hello;
	...
	soap_serialize_HELLO__hello(soap, &soap_tmp_HELLO__hello);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put_HELLO__hello(soap, &soap_tmp_HELLO__hello, "HELLO:hello", NULL)
	...
	*p = NULL;
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_tmp_HELLO__helloResponse = soap_get_HELLO__helloResponse(soap, NULL, "HELLO:helloResponse", "");
	if (soap->error)
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (p && soap_tmp_HELLO__helloResponse->p)
		*p = *soap_tmp_HELLO__helloResponse->p;
	return soap_closesock(soap);
}
