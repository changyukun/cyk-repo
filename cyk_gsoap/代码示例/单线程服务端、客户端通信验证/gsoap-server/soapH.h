...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_HELLO__hello(struct soap*, struct HELLO__hello *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_HELLO__hello(struct soap*, const struct HELLO__hello *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_HELLO__hello(struct soap*, const char*, int, const struct HELLO__hello *, const char*);
SOAP_FMAC3 struct HELLO__hello * SOAP_FMAC4 soap_in_HELLO__hello(struct soap*, const char*, struct HELLO__hello *, const char*);

#ifndef soap_write_HELLO__hello
#define soap_write_HELLO__hello(soap, data) ( soap_begin_send(soap) || (soap_serialize_HELLO__hello(soap, data), 0) || soap_put_HELLO__hello(soap, data, "HELLO:hello", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_HELLO__hello(struct soap*, const struct HELLO__hello *, const char*, const char*);

#ifndef soap_read_HELLO__hello
#define soap_read_HELLO__hello(soap, data) ( soap_begin_recv(soap) || !soap_get_HELLO__hello(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct HELLO__hello * SOAP_FMAC4 soap_get_HELLO__hello(struct soap*, struct HELLO__hello *, const char*, const char*);

#ifndef SOAP_TYPE_HELLO__helloResponse
#define SOAP_TYPE_HELLO__helloResponse (9)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_HELLO__helloResponse(struct soap*, struct HELLO__helloResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_HELLO__helloResponse(struct soap*, const struct HELLO__helloResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_HELLO__helloResponse(struct soap*, const char*, int, const struct HELLO__helloResponse *, const char*);
SOAP_FMAC3 struct HELLO__helloResponse * SOAP_FMAC4 soap_in_HELLO__helloResponse(struct soap*, const char*, struct HELLO__helloResponse *, const char*);

#ifndef soap_write_HELLO__helloResponse
#define soap_write_HELLO__helloResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_HELLO__helloResponse(soap, data), 0) || soap_put_HELLO__helloResponse(soap, data, "HELLO:helloResponse", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_HELLO__helloResponse(struct soap*, const struct HELLO__helloResponse *, const char*, const char*);

#ifndef soap_read_HELLO__helloResponse
#define soap_read_HELLO__helloResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_HELLO__helloResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct HELLO__helloResponse * SOAP_FMAC4 soap_get_HELLO__helloResponse(struct soap*, struct HELLO__helloResponse *, const char*, const char*);
